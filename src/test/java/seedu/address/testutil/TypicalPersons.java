...
public class TypicalPersons {
    ...
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street").withTags("vip").build();
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("94822248")
            .withEmail("werner@example.com").withAddress("michegan ave").withTags("friend").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("94824278")
            .withEmail("lydia@example.com").withAddress("little tokyo").withTags("vip").build();
