...
public class EditCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        // negative index (must be positive) with correct prefix
        ...
        // anything in preamble is invalid now (old style index without prefix)
        assertParseFailure(parser, "1 some random string", MESSAGE_INVALID_FORMAT);

        // invalid prefix being parsed as preamble / stray text before prefixes
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = " i/" + targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
        ...
        userInput = " i/" + targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC
