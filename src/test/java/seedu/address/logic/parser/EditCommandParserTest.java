...
public class EditCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        // anything in preamble is invalid now (index must be i/ and preamble empty)
        assertParseFailure(parser, "1" + NAME_DESC_AMY, MESSAGE_INVALID_FORMAT);
        assertParseFailure(parser, "random " + NAME_DESC_AMY, MESSAGE_INVALID_FORMAT);
        assertParseFailure(parser, "i/ " + NAME_DESC_AMY, MESSAGE_INVALID_FORMAT); // malformed i/
    }

    @Test
    public void parse_invalidIndex_failure() {
        assertParseFailure(parser, "i/0" + NAME_DESC_AMY, MESSAGE_INVALID_FORMAT);  // zero index
        assertParseFailure(parser, "i/-5" + NAME_DESC_AMY, MESSAGE_INVALID_FORMAT); // negative index
        assertParseFailure(parser, "i/abc" + NAME_DESC_AMY, MESSAGE_INVALID_FORMAT); // non-numeric
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "i/1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_ADDRESS_AMY + VALID_PHONE_AMY,
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = "i/" + targetIndex.getOneBased() + INVALID_PHONE_DESC + PHONE_DESC_BOB;
        assertParseFailure(parser, userInput, Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PHONE));

        // invalid followed by valid
        userInput = "i/" + targetIndex.getOneBased() + PHONE_DESC_BOB + INVALID_PHONE_DESC;
        assertParseFailure(parser, userInput, Messages.getErrorMessageForDuplicatePrefixes(PREFIX_PHONE));
    }
