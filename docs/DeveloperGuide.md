...
**`Main`** (consisting of classes [`Main`](https://github.com/AY2526S1-CS2103T-T14-4/tp/blob/master/src/main/java/seedu/address/Main.java) and [`MainApp`](https://github.com/AY2526S1-CS2103T-T14-4/tp/blob/master/src/main/java/seedu/address/MainApp.java)) is in charge of the app launch and shut down.
...
The **API** of this component is specified in [`Ui.java`](https://github.com/AY2526S1-CS2103T-T14-4/tp/blob/master/src/main/java/seedu/address/ui/Ui.java)
...
**API** : [`Logic.java`](https://github.com/AY2526S1-CS2103T-T14-4/tp/blob/master/src/main/java/seedu/address/logic/Logic.java)
...
### Model component
**API** : [`Model.java`](https://github.com/AY2526S1-CS2103T-T14-4/tp/blob/master/src/main/java/seedu/address/model/Model.java)
...
**API** : [`Storage.java`](https://github.com/AY2526S1-CS2103T-T14-4/tp/blob/master/src/main/java/seedu/address/storage/Storage.java)
...
2.  Should be able to hold up to 250 seniors without a noticeable sluggishness in performance for typical usage.
